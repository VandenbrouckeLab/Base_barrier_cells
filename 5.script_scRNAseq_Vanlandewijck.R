## Vanlandewijck script: GSE98816 -> raw read counts!!
...
sampleName<-"GSE98816_Vanlandewijck"
...
########## LOAD DATA
################################################################################
## Vanlandewijck vascular cells (Perform filter????)
rawDataSparse <- read.table("GSE98816_Vanlandewijck/GSE98816_Brain_samples_raw_read_counts_matrix.txt", header = T)
rownames(rawDataSparse)<-rawDataSparse[,1]
rawDataSparse<-rawDataSparse[,-1]
